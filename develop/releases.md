...
* **scss** - _Style Dictionary _scss variables can be imported by _@import "node\_modules/\[your-package-name]/scss/\_variables.scss"_ by default.
* **less** - _Style Dictionary less _variables can be imported by _@import "node\_modules/\[your-package-name]/less/\_variables.less"_ by default.
* **css** - _Style Dictionary _css variables can be imported by _@import "node\_modules/\[your-package-name]/css/\_variables.css"_ by default.
